            ...
            < Back</a>
                ...
                <form action="/dokter/{{$dokter->id}}" method="post" class="mx-2">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Pasien" value="{{$dokter->nama}}">
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="number" class="form-control" name="telp" placeholder="Masukkan No. Telp" value="{{$dokter->telp}}">
                    </div>
